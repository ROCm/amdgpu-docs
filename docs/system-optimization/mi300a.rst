...
the AMD Instinct MI300A GPU. This topic can help you optimize performance.
...
performance because the OS on an accelerated processing unit (APU) is responsible for memory management across the CPU and GPUs.
