.. meta::
   ...
   :keywords: AMD, Instinct, MI300X, HPC, tuning, BIOS settings, NBIO, ROCm,
              environment variable, performance, GPU, EPYC, GRUB,
              operating system
...
for AMD Instinct™ MI300X GPUs. It is important to ensure a system is
...
:doc:`rocm:how-to/rocm-for-ai/inference-optimization/workload` for how to improve performance for
...
MI300X GPU delivers improved performance for small language models (13B
