...
html_theme_options = {
    "flavor": "amdgpu",
    "announcement": f"<a id='rocm-banner' href='https://instinct.docs.amd.com/projects/amdgpu-docs/en/31.10.0-preview/'>AMD GPU Driver 31.10.0</a> is a technology preview intended for use only with <a id='rocm-banner' href='https://rocm.docs.amd.com/en/7.11.0-preview/index.html'>AMD ROCm 7.11.0 technology preview</a>. For production use, continue to use AMD GPU Driver {version} documentation.",
    "link_main_doc": True,
