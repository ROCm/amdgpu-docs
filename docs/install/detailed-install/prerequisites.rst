...
1. Confirm the system has a supported Linux version.
   ...
   * Confirm that your Linux distribution matches a `supported distribution <https://rocm.docs.amd.com/en/docs-7.14.0/about/release-notes.html#operating-system-support>`_.
...
2. Verify the kernel version.
   ...
   * Confirm that your kernel version matches the system requirements, as listed in `Operating system support <https://rocm.docs.amd.com/en/docs-7.14.0/about/release-notes.html#operating-system-support>`_
